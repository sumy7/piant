    ...
    <View style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <TextView style={{ textAlign: 'right' }}>
          <Span style={{ fontSize: 40, color: 'red' }}>Right Aligned Text</Span>
          <Span style={{ fontSize: 15, color: 'blue' }}>
      ...
      <View style={styles.section}>
        ...
        <TextView style={{ fontSize: 20, color: 'purple', lineHeight: 40 }}>
          <Span>
            Line height test: This text should have a line height of 40 pixels,
            making the lines more spaced out than usual.
          </Span>
        ...
        <TextView style={{ fontSize: 20, color: 'brown', letterSpacing: 5 }}>
          <Span>
            Letter spacing test: The letters in this text should be spaced out
            by 5 pixels, making it easier to read and visually appealing.
          </Span>
        </TextView>
      </View>
      ...
      <View style={styles.section}>
        ...
        <TextView
          style={{ fontSize: 20, color: 'black', textTransform: 'uppercase' }}
        >
          <Span>
            Text Transform test: this text should be transformed to uppercase.
          </Span>
        </TextView>
        <TextView
          style={{ fontSize: 20, color: 'black', textTransform: 'lowercase' }}
        >
          <Span>
            Text Transform test: THIS TEXT SHOULD BE TRANSFORMED TO LOWERCASE.
          </Span>
        </TextView>
        <TextView
          style={{ fontSize: 20, color: 'black', textTransform: 'capitalize' }}
        >
        ...
        >
          <Span>
            ...
            demonstrate the text overflow behavior when the content exceeds the
            specified width of the TextView component. It should be truncated
            with an ellipsis if it does not fit within the given space.
          </Span>
        </TextView>
      </View>
    </View>
